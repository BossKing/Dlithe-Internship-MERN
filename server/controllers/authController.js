...
const allowedAdminEmails = ["sumanthap799@gmail.com", "admin2@charity.org"]; // ✅ Only these can login as admins
...
exports.register = async (req, res) => {
  try {
    ...
    // ✅ Restrict Admin registration to allowed emails only
    if (role === "Admin" && !allowedAdminEmails.includes(email)) {
      return res.status(403).json({ msg: "Not authorized to register as Admin" });
    }
